...
class TemporalTransformerBlock(nn.Module):
    def __init__(
            ...
            num_attention_heads,
            attention_head_dim,
            attention_block_types=("Temporal_Self", "Sparse_Causal",),
            dropout=0.0,
            norm_num_groups=32,
            cross_attention_dim=768,
            activation_fn="geglu",
        ...
        for block_name in attention_block_types:
            if "Temporal_Self" in block_name:
                self.attention_blocks.append(
                    VersatileAttention(
                        attention_mode="Temporal",
                        cross_attention_dim=None,  # Update this based on your logic
                        query_dim=dim,
            ...
            if "Sparse_Causal" in block_name:
                # Assuming "Sparse_Causal" indicates the use of SparseCausalAttention
                self.attention_blocks.append(
